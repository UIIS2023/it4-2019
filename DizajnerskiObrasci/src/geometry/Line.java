...
public class Line extends Shape {
	...
	public String toString() {
		return "Line: Point(" + startPoint.getX() +"," + startPoint.getY() +")" + "-->" +"Point("+ endPoint.getX() +"," + endPoint.getY() +")" + ", " + getColor();
	}
	...
	public Line clone() {
		...
		line.setStartPoint(new Point(this.getStartPoint().getX(), this.getStartPoint().getY()));
		line.setEndPoint(new Point(this.getEndPoint().getX(), this.getEndPoint().getY()));
