...
public class Rectangle extends SurfaceShape {
	...
	public String toString() {
		return "Rectangle: Upper left point=" + "Point(" +upperLeftPoint.getX()+"," +upperLeftPoint.getY() +")" + ", width=" + width + ", height=" + height + ",edgeColor= "  + this.getColor() + ",innerColor=" + this.getInnerColor();
	}
